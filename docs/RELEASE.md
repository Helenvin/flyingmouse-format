...
已获授权的手动发布按以下顺序进行，保留原安装器，不触发另一轮构建覆盖它：
...
3. 回读 draft、标签提交、远程文件名、状态、字节数和 SHA-256，核对安装器为 1,515,803,399 字节、摘要 `56c022bc5ec1904300c8ffe77f892d0bea09fe157fbbf402589a64decab2587b`，且与本地已验收文件一致。
